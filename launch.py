...
def prepare_environment():
    ...
    comfy_repo = os.environ.get('COMFY_REPO', "https://github.com/camenduru/ComfyUI")
    comfy_commit_hash = os.environ.get('COMFY_COMMIT_HASH', "e1e94a41085107865ea762b61e64509c16703222")
